...
printf "The test points will be saved in $SAVE_DIR.\n"
...
Rscript /home/jsa378/bo_partition/code/implementation_testing/test_points/gen_test_points.R $TEST_FUNC $DIM $NUM_TEST_PTS $SAVE_DIR

printf "Test points created and saved.\n"
