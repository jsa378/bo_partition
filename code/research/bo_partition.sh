...
Rscript /home/jsa378/bo_partition/code/research/bo_partition.R $SEED $TEST_FUNC $DIM $NUM_INIT_OBS $NUM_OBS $NUM_RUNS $N_MAX $TOL $SPLIT_CRIT $SAVE_DIR
...
then
  ...
  python /home/jsa378/bo_partition/code/research/plots.py $SEED $TEST_FUNC $DIM $NUM_INIT_OBS $NUM_OBS $NUM_RUNS $N_MAX $TOL $SPLIT_CRIT $SAVE_DIR $NUM_ARRAY_JOBS
else
