...
SAVE_DIR=/home/jsa378/scratch/${TEST_FUNC}_v5_${DIM}_dim_${N_MAX}_nmax_${NUM_SUBSEQ_OBS}_numsubseqobs/
NUM_ARRAY_JOBS=10
...
Rscript /home/jsa378/bo_partition/code/research/v5/bo_partition.R $SEED $TEST_FUNC $DIM $NUM_INIT_OBS $NUM_SUBSEQ_OBS $NUM_RUNS $N_MAX $TOL $HOW_MANY_EI_POINTS $TOP_N_EI_VALS $POINT_SHARE_TOL $SAVE_DIR $SLURM_JOB_ID
