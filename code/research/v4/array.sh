...
Rscript /home/jsa378/bo_partition/code/research/v4/bo_partition.R $SEED $TEST_FUNC $DIM $NUM_INIT_OBS $NUM_SUBSEQ_OBS $NUM_RUNS $N_MAX $TOL $HOW_MANY_EI_POINTS $TOP_N_EI_VALS $SAVE_DIR $SLURM_JOB_ID $COVTYPE $NUGGET $MIN_CONSIDER_REJECT
