...
test_func_names = ['ackley']

obs = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[0]}_obs.csv', header=None, dtype=float, sep='\s+').to_numpy()
best = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[0]}_best_so_far.csv', header=None, dtype=float, sep='\s+').to_numpy()
x_axis_step_size = 5
...
reg_1_obs = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[0]}_reg_1_obs.csv', header=None, dtype=float, sep='\s+').to_numpy()
reg_1_best = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[0]}_reg_1_best_so_far.csv', header=None, dtype=float, sep='\s+').to_numpy()
...
reg_2_obs = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[0]}_reg_2_obs.csv', header=None, dtype=float, sep='\s+').to_numpy()
reg_2_best = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[0]}_reg_2_best_so_far.csv', header=None, dtype=float, sep='\s+').to_numpy()
...
plt.title(f'{test_func_names[0]} ({num_runs} runs)')
plt.legend()
plt.savefig(f'/Users/jesse/Downloads/bo_partition/plots/bo_runs/{test_func_names[0]}_obs.png')
plt.clf()