...
reg_1_obs = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[2]}_reg_1_obs.csv', header=None, dtype=float, sep='\s+').to_numpy()
reg_1_best = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[2]}_reg_1_best_so_far.csv', header=None, dtype=float, sep='\s+').to_numpy()
...
reg_2_obs = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[2]}_reg_2_obs.csv', header=None, dtype=float, sep='\s+').to_numpy()
reg_2_best = pd.read_csv(f'/Users/jesse/Downloads/bo_partition/data/bo_runs/{test_func_names[2]}_reg_2_best_so_far.csv', header=None, dtype=float, sep='\s+').to_numpy()
...
plt.plot(x_axis, global_mins['grie'] * np.ones(num_obs), label='global min.', color='black')
...
plt.title(f'{test_func_names[2]} ({num_runs} runs)')
plt.legend()
plt.savefig(f'/Users/jesse/Downloads/bo_partition/plots/bo_runs/{test_func_names[2]}_obs.png')
plt.clf()