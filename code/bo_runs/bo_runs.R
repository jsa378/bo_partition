...
test_func = cit
test_lbound_scalar = cit_lbound_scalar
test_ubound_scalar = cit_ubound_scalar
plot_lims = c(test_lbound_scalar, test_ubound_scalar)
test_lbound = cit_lbound
test_ubound = cit_ubound
