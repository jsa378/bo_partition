...
test_func_string = c("neg_fourpeak")
num_init_obs = 20
...
test_func = neg_fourpeak
test_lbound_scalar = neg_copeak_lbound_scalar
test_ubound_scalar = neg_copeak_ubound_scalar
plot_lims = c(test_lbound_scalar, test_ubound_scalar)
test_lbound = neg_copeak_lbound
test_ubound = neg_copeak_ubound
